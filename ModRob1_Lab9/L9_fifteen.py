...
theta,omega_hat,omega_hat_bracket=w_hat_and_theta_given_R(T_sample)
print(theta)
print(omega_hat)
print(omega_hat_bracket)

def s_nu():
    s_v= ((1/theta)*np.eye[3])-(0.5*omega_hat_bracket)+(((1/theta)-(0.5*np.cot(theta/2)))*(omega_hat**2))
